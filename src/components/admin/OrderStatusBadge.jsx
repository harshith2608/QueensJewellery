...
export default function OrderStatusBadge({ status, refunded }) {
  ...
  return (
    <div className="flex items-center gap-1.5 flex-wrap">
      ...
      {refunded && (
        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border bg-orange-100 text-orange-700 border-orange-200">
          Refunded
        </span>
      )}
    </div>
